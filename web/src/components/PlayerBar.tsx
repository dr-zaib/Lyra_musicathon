      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="flex items-center gap-3 py-2 md:grid md:grid-cols-[1fr_auto_1fr] md:gap-4">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-3 md:flex-none">
            <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-md bg-bg-elev-2">
              {track?.artwork_url ? (
          ...
          {/* CENTER — transport (seek lives as the slim line at the top of the bar) */}
          <div className="flex items-center justify-center gap-1">
            <button onClick={onPrev} disabled={!hasPrev} className={ctrl} aria-label="Previous"><PrevIcon /></button>
            <button
              onClick={onToggle}
              className="flex h-12 w-12 items-center justify-center rounded-full bg-accent text-bg transition hover:scale-105 hover:brightness-110"
